...
#' Fit SDE-IG to a real RR vector  (thin wrapper around sde_ig())
#'
#' @inheritParams sde_ig
#' @param rr_vec  Numeric vector of RR intervals in seconds.
#' @return An `"sde_ig_fit"` object; see `?sde_ig`.
#' @seealso [sde_ig()]
